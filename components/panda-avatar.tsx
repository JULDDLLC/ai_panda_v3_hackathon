...
export function PandaAvatar({ 
  ...
  // Remove individual voice handling to prevent double audio
  const handleClick = () => {
    // Voice will be handled by parent component only
    console.log('Panda clicked - voice handled by parent');
  };
